...
train_raw = mz.load_data_pack('amazon100Kproducts_train.datapack')
test_raw = mz.load_data_pack('amazon100Kproducts_test.datapack')

preprocessor = mz.preprocessors.BasicPreprocessor(fixed_length_left=MAX_LEN_LEFT,fixed_length_right=MAX_LEN_RIGHT)
